## Privacy Policy for White Mountain Peak Tracker iOS App: https://nathanbeaumont.github.io/white-mountains-ios-app/

In order to receive information about your Personal Data, the purposes and the parties the Data is shared with, contact the Owner.

# Owner and Data Controller
Types of Data collected
The app collects the user's email for password recovery purposes only. The app also collects the user's hiking progress on each of the New Hampshire 48 four thousand footers. 
